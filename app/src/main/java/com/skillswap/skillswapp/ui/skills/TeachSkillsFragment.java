...
import com.skillswap.skillswapp.databinding.FragmentTeachSkillsBinding;
...
/**
 * Fragmento para gestionar las habilidades que el usuario puede enseñar.
 */
public class TeachSkillsFragment extends Fragment implements SkillAdapter.OnSkillClickListener {

    private FragmentTeachSkillsBinding binding;
    ...
    public View onCreateView(@NonNull LayoutInflater inflater, ViewGroup container, Bundle savedInstanceState) {
        binding = FragmentTeachSkillsBinding.inflate(inflater, container, false);
    ...
    private void setupRecyclerView() {
        skillAdapter = new SkillAdapter(true);
    ...
    private void loadUserSkills() {
        ...
        userViewModel.getUserById(userId).observe(getViewLifecycleOwner(), user -> {
            ...
            if (user != null && user.getSkillsToTeach() != null && !user.getSkillsToTeach().isEmpty()) {
                skillAdapter.setSkills(user.getSkillsToTeach());
    ...
    public void onSkillClick(SkillAdapter.SkillItem skill) {
        ...
        args.putBoolean("isTeachSkill", true);
