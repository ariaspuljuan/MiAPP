...
/**
 * Diálogo para agregar una nueva habilidad.
 */
public class AddSkillDialogFragment extends DialogFragment {
    ...
    public Dialog onCreateDialog(@Nullable Bundle savedInstanceState) {
        ...
        return new MaterialAlertDialogBuilder(requireContext())
                .setTitle(isTeachSkill ? R.string.add_skill_to_teach : R.string.add_skill_to_learn)
    ...
    private void saveSkill() {
        ...
        if (isTeachSkill) {
            ...
            User.SkillToTeach skill = new User.SkillToTeach();
            ...
            String skillId = userViewModel.generateSkillId();
            userViewModel.updateUserField(userId, "skills_to_teach/" + skillId, skillMap).observe(this, success -> {
                if (success) {
                    ...
                    userViewModel.addSkillToGlobal(skillId, title, categoryId, userId);
            ...
            // Crear objeto de habilidad
            User.SkillToLearn skill = new User.SkillToLearn();
            skill.setTitle(title);
